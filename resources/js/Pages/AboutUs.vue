                    ...
                    <div class="row">
                        <div class="col-md-6 col-lg-3">
                            <div class="team-item wow fadeInUp" data-wow-delay=".25s">
                                <div class="team-img">
                                    <img src="assets/img/team/founder.jpeg" alt="thumb" />
                                </div>
                                ...
                                <div class="team-content">
                                    <div class="team-bio">
                                        <h5><a href="#">Ivo Doh</a></h5>
                                        <span>CEO & Foudner</span>
                                    </div>
                                </div>
                        ...
                        <div class="col-md-6 col-lg-3">
                            <div class="team-item wow fadeInUp" data-wow-delay=".50s">
                                <div class="team-img">
                                    <img src="assets/img/team/carlson.jpeg" alt="thumb" />
                                </div>
                                <div class="team-social">
                                    <a href="#"><i class="fab fa-facebook-f"></i></a>
                                    <a href="#"><i class="fab fa-whatsapp"></i></a>
                        ...
                        <div class="col-md-6 col-lg-3">
                            <div class="team-item wow fadeInUp" data-wow-delay=".75s">
                                <div class="team-img">
                                    <img src="assets/img/team/hanslett.jpg" alt="thumb" />
                                </div>
                                <div class="team-social">
                                    <a href="#"><i class="fab fa-facebook-f"></i></a>
                                    <a href="#"><i class="fab fa-whatsapp"></i></a>
                        ...
                        <div class="col-md-6 col-lg-3">
                            <div class="team-item wow fadeInUp" data-wow-delay="1s">
                                <div class="team-img">
                                    <img src="assets/img/team/marymuse.jpeg" alt="thumb" />
                                </div>
                                <div class="team-social">
                                    <a href="#"><i class="fab fa-facebook-f"></i></a>
                                    <a href="#"><i class="fab fa-whatsapp"></i></a>
