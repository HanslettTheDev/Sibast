                        ...
                        <div class="about-right wow fadeInRight" data-wow-delay=".25s">
                            <div class="site-heading mb-3">
                                <span class="site-title-tagline"><i class="far fa-book-open-reader"></i> About
                                    Us</span>
                                <h2 class="site-title">
                                    Our Sibast Education System
                                    <span>Inspires</span> You More.
                                </h2>
                            </div>
                            <p class="about-text">
                                There are many variations of passages available but
                                the majority have suffered alteration in some form
                                by injected humour randomised words which don't look
                            ...
                            <div class="about-bottom">
                                ...
                                <div class="about-phone">
                                    ...
                                    <div class="number">
                                        <span>Call Now</span>
                                        <h6>
                                            <a href="tel:+21236547898">+237 678 31 15 73</a>
                                        </h6>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="course-item wow fadeInUp" data-wow-delay=".25s">
                            ...
                            <div class="course-content">
                                <div class="course-meta">
                                    <span class="course-meta-left"><i class="far fa-book"></i> 10
                                        Lessons</span>
                                ...
                                <div class="course-bottom">
                                    <div class="course-bottom-left">
                                        <span><i class="far fa-users"></i>75
                                            Seats</span>
                                        <span><i class="far fa-clock"></i>04
                                            Years</span>
                                    </div>
                ...
                <div class="row g-4">
                    <div class="col-lg-4 wow fadeInLeft" data-wow-delay=".25s">
                        ...
                        <p class="about-text">
                            ...
                            injected humour look even slightly believable.
                        </p>
                    ...
                    <div class="row align-items-center">
                        <div class="col-lg-5 ms-lg-auto">
                            <div class="cta-content">
                                <h1>
                                    Our 20% Offer Running - Join Today For Your
                                    Course
                                </h1>
                                <p>
                ...
                <div class="event-slider owl-carousel owl-theme">
                    <div class="event-item">
                        <div class="event-location">
                            <span><i class="far fa-map-marker-alt"></i> 25/B Milford
                                Road, New York</span>
                        </div>
                        <div class="event-img">
                        ...
                        <div class="event-info">
                            <div class="event-meta">
                                <span class="event-date"><i class="far fa-calendar-alt"></i>16 June,
                                    2024</span>
                                <span class="event-time"><i class="far fa-clock"></i>10.00AM -
                                    04.00PM</span>
                            </div>
                    ...
                    <div class="col-md-6 col-lg-4">
                        <div class="blog-item wow fadeInUp" data-wow-delay=".25s">
                            ...
                            <div class="blog-item-info">
                                ...
                                <h4 class="blog-title">
                                    <a href="blog-single.html">There are many variations passage have
                                        suffered available.</a>
                                </h4>
